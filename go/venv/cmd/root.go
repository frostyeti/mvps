...
var rootCmd = &cobra.Command{
	Use:   "venv [OPTIONS] [NAME=VALUE...] [ENV_FILE...] [COMMAND] [ARG...]",
	Short: "venv sets environment variables and executes a command",
	Long: `venv sets environment variables from the command line, .env files, or both,
...
`,
	Example: `venv -e NAME=VALUE -e ANOTHER=VALUE2 -E ./.env  --chdir /opt/bin bash -c 'echo $NAME $ANOTHER'`,
	Version: Version,
...
func init() {
	...
	// rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.venv.yaml)")
